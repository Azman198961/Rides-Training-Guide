...
TOPICS[9].html.bn = `
<p class="lead">রাইডস টিমের কোয়ালিটি অ্যাসুরেন্স মানদণ্ড, কল ইভালুয়েশন ও স্কোরিং গাইড।</p>

<h3>১. চ্যানেল ভিত্তিক QA মানদণ্ড</h3>
<p>প্রতিটি চ্যানেলের আলাদা স্কোরিং কাঠামোর জন্য সংশ্লিষ্ট কার্ড ক্লিক করুন:</p>
    ...
    <table class="qa-table">
      ...
      <tbody>
        <tr class="section-header-row">
          <td colspan="2">সফট স্কিল ও কল এটিকেট (Soft Skill & Call Etiquette)</td>
        </tr>
        <tr><td>ওয়েলকাম গ্রিটিংস</td><td>৫.০</td></tr>
        <tr><td>কথা না কেটে বা ওভারল্যাপ না করে সঠিকভাবে সাড়া দেওয়া</td><td>৮.০</td></tr>
        <tr><td>ম্যাজিক ওয়ার্ডস, এম্প্যাথি ও প্রফেশনালিজম বজায় রাখা</td><td>১০.০</td></tr>
        <tr><td>সঠিক উচ্চারণে কথা বলা (জার্গন এড়িয়ে চলা)</td><td>৩.০</td></tr>
        <tr><td>সঠিক হোল্ড প্রসেস বজায় রাখা</td><td>৩.০</td></tr>
        <tr><td>আরও সাহায্যের সুযোগ জানতে চাওয়া</td><td>২.০</td></tr>
        <tr><td>সুন্দর সমাপ্তি সংলাপ (Closing Dialogues)</td><td>৫.০</td></tr>
        <tr><td>CSAT ট্রান্সফার করা</td><td>৪.০</td></tr>
        <tr class="section-header-row">
          <td colspan="2">সার্ভিস নলেজ ও সিই প্যারামিটার (Service Knowledge)</td>
        </tr>
        <tr><td>কার্যকর অনুসন্ধান (Effective Probing)</td><td>৬.০</td></tr>
        <tr><td>সমস্যা চিহ্নিতকরণ ও সমাধানের দক্ষতা</td><td>১০.০</td></tr>
        <tr><td>সঠিক এসকেলেশন ও সিআরএম নোট প্রদান</td><td>৬.০</td></tr>
        <tr><td>সঠিক তথ্য বা সেবা প্রদান করা</td><td>১০.০</td></tr>
        <tr><td>সম্পূর্ণ তথ্য প্রদান করা</td><td>১০.০</td></tr>
        <tr><td>টুলস ও রিসোর্সের সঠিক ব্যবহার</td><td>৮.০</td></tr>
        <tr><td>সঠিক সিআরএম ক্যাচরি ও র‍্যাপ-আপ</td><td>১০.০</td></tr>
      </tbody>
    </table>
  </div>
</details>
...
<details class="qa-card">
  ...
  <div class="qa-card-content">
    <table class="qa-table">
      ...
      <tbody>
        <tr class="section-header-row">
          <td colspan="2">সফট স্কিল ও রাইটিং ম্যানারিজম (৫০%)</td>
        </tr>
        <tr><td>ওপেনিং ও ক্লোজিং গ্রিটিংস</td><td>৫</td></tr>
        <tr><td>সঠিকভাবে একনলেজ বা রেসপন্স করা</td><td>৭</td></tr>
        <tr><td>অনুরূপ ফরম্যাট/ভাষা/বানান ব্যবহার</td><td>৪</td></tr>
        <tr><td>বিনয়ী ও আন্তরিক ভাষা / এম্প্যাথি দেখানো</td><td>৫</td></tr>
        <tr><td>সঠিক রিপ্লাই টাইমিং ও হোল্ড প্রসেস</td><td>৭</td></tr>
        <tr><td>ব্যাকরণ ও পাঙ্কচুয়েশন ঠিক রাখা</td><td>৭</td></tr>
        <tr><td>লেইট ক্লোজিং না করা</td><td>৬</td></tr>
        <tr><td>সাহায্য করার মানসিকতা ও ওনারশিপ নেওয়া</td><td>৬</td></tr>
        <tr><td>উত্তর দেওয়ার পেশাদারিত্ব</td><td>৩</td></tr>
        <tr class="section-header-row">
          <td colspan="2">সার্ভিস নলেজ ও সিই প্যারামিটার (৫০%)</td>
        </tr>
        <tr><td>সঠিক এসকেলেশন, রেজ্যুলেশন ও ফলো-আপ</td><td>৮</td></tr>
        <tr><td>টুলস ও রিসোর্সের সঠিক ব্যবহার</td><td>৭</td></tr>
        <tr><td>ইস্যু অনুসন্ধান ও চিহ্নিতকরণ</td><td>৮</td></tr>
        <tr><td>সঠিক তথ্য/সেবা প্রদান</td><td>৮</td></tr>
        <tr><td>সম্পূর্ণ তথ্য/সেবা প্রদান</td><td>৮</td></tr>
        <tr><td>সঠিক আরটিসি ট্যাগিং (RTC Tag)</td><td>৮</td></tr>
        <tr><td>আরও কোনো সহায়তা প্রয়োজন কিনা তা জানা</td><td>৩</td></tr>
      </tbody>
    </table>
  </div>
</details>
